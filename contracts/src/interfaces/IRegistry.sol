...
/// @notice This interface is used to register FLIP contracts
interface IRegistry {
    ...
    /// @notice Error emitted when a contract does not implement IFlip interface
    error ContractDoesNotImplementIFlipInterface();
